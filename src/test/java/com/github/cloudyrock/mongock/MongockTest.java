...
public class MongockTest extends MongockTestBase {
  ...
  public void shouldUsePreConfiguredMongoTemplate() throws Exception {
    ...
    when(changeEntryRepository.isNewChange(any(ChangeEntry.class))).thenReturn(true);
    runner.setChangelogMongoTemplate(mt);
  ...
  public void shouldUsePreConfiguredJongo() throws Exception {
    ...
    runner.setChangelogJongo(jongo);
...
//  }
  ...
  public void shouldInjectProxyToChangeEntry() throws Exception {
    ...
    doReturn(Arrays.asList(
        ...
        ProxiesMongockTestResource.class.getDeclaredMethod("testJongo", Jongo.class),
    ...
    runner.setChangelogJongo(proxyJongo);
