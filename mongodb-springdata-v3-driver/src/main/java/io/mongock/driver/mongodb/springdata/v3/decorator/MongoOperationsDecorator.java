...
import io.mongock.driver.mongodb.springdata.v3.decorator.impl.CloseableIteratorDecoratorImpl;
import io.mongock.driver.mongodb.springdata.v3.decorator.impl.IndexOperationsDecoratorImpl;
import io.mongock.driver.mongodb.springdata.v3.decorator.impl.MongoOperationsDecoratorImpl;
import io.mongock.driver.mongodb.springdata.v3.decorator.impl.ScriptOperationsDecoratorImpl;
import io.mongock.driver.mongodb.springdata.v3.decorator.impl.SessionScopedDecoratorImpl;
import io.mongock.driver.mongodb.springdata.v3.decorator.operation.executable.aggregation.impl.ExecutableAggregationDecoratorImpl;
import io.mongock.driver.mongodb.springdata.v3.decorator.operation.executable.find.impl.ExecutableFindDecoratorImpl;
import io.mongock.driver.mongodb.springdata.v3.decorator.operation.executable.insert.impl.ExecutableInsertDecoratorImpl;
import io.mongock.driver.mongodb.springdata.v3.decorator.operation.executable.mapreduce.impl.MapReduceWithMapFunctionDecoratorImpl;
import io.mongock.driver.mongodb.springdata.v3.decorator.operation.executable.remove.impl.ExecutableRemoveDecoratorImpl;
import io.mongock.driver.mongodb.springdata.v3.decorator.operation.executable.update.impl.ExecutableUpdateDecoratorImpl;
