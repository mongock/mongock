...
@NotThreadSafe
public abstract class MongoSync4DriverGeneric<CHANGE_ENTRY extends ChangeEntry> extends MongoSync4DriverBase<CHANGE_ENTRY> {

  private final MongoClient mongoClient;
  private boolean transactionEnabled = true;

  protected MongoSync4DriverGeneric(MongoClient mongoClient,
                             String databaseName,
