 ...
 */
public interface ILockRepository<LOCK extends LockEntry>  {
   ...
   */
  void insertUpdate(LOCK newLock) throws LockPersistenceException;
   ...
   *                                  another owner or cannot insert/update the lock for any other reason
   */
  void updateIfSameOwner(LOCK newLock) throws LockPersistenceException;
