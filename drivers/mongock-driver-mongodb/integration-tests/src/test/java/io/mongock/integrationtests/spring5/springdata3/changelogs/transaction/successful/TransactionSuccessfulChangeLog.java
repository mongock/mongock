package io.mongock.integrationtests.spring5.springdata3.changelogs.transaction.successful;
...
public class TransactionSuccessfulChangeLog {
    ...
    public void methodSuccessful(MongockTemplate template) {
        ...
        Collection<ClientExtended> result = template.insert(clients, Mongock4Spring5SpringData3App.CLIENTS_COLLECTION_NAME);
    }
